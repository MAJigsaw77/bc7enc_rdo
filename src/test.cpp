...
static int print_usage()
{
    ...
    fprintf(stderr, "\n");
    fprintf(stderr, "-uX BC7: Set the BC7 base encoder quality level. X ranges from [0,4]. Default is 4 (highest quality).\n");
    ...
    fprintf(stderr, "\n\"bc7enc -e blah.png\" - Reduced entropy BC7 encoding (extremely fast, but only 5-10%% gains, and only 4 BC7 modes)\n");
